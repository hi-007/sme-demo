...
//import type { RadioChangeEvent } from 'antd/es/radio/interface'; // นำเข้าประเภทนี้เพื่อให้แน่ใจว่าใช้ประเภทที่ถูกต้อง
...
const PlatformRegis: React.FC = () => {
    ...
    const handleSubmit = (values: any) => {
        setFormData(values);  // เก็บข้อมูลที่กรอก
        setIsModalVisible(true);  // แสดง Modal
    };


    const [isModalVisible, setIsModalVisible] = useState(false); // สำหรับการแสดง Modal ตรวจสอบ
    const [isSuccessModalVisible, setIsSuccessModalVisible] = useState(false); // สำหรับการแสดง Modal success

    // const handleShowModal = () => {
    //   setIsModalVisible(true); // เปิด Modal ตรวจสอบ
    // };

    const handleCloseModal = () => {
        setIsModalVisible(false); // ปิด Modal ตรวจสอบ
    };
    ...
    const handleCloseSuccessModal = () => {
        ...
        navigate('/');  // ไปยังหน้าหลักเมื่อปิด modal
    };
    ...
    // const renderIndustryWarning = (industry: string) => {
    //     switch (industry) {
    //         case 'PublicSectorStability':
    //             return 'ด้านความมั่นคงภาครัฐ';
    //         case 'KeyPublicSectorServices':
    //             return 'ด้านบริการภาครัฐที่สำคัญ';
    //         case 'InformationTechnologyandTelecommunications':
    //             return 'ด้านเทคโนโลยีสารสนเทศและโทรคมนาคม';
    //         default:
    //             return 'ไม่มีข้อควรระวังเฉพาะสำหรับประเภทนี้';
    //     }
    // };
                            ...
                            <div className="grid lg:grid-cols-1 gap-12 ">
                                ...
                                <div className="bg-white/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-200/50 relative overflow-hidden">
                                    ...
                                    >
                                        ...
                                        >
                                            <Radio.Group>
                                                <Radio value="corporate1">ภาคการผลิต</Radio>
                                                <Radio value="individual2">ภาคการค้า/การบริการ</Radio>
                                            </Radio.Group>
                                        </Form.Item>
                                            ...
                                            <Radio.Group className="flex flex-col space-y-2">
                                                {sizeOptions.map((opt) => (
                                                    <Radio
                                                        key={opt.value}
                                                        value={opt.value}
                                                        disabled={selectedSize !== opt.value} // ✅ จะ refresh ทุกครั้งที่ sizeCategory เปลี่ยน
                                                        defaultChecked
                                                    >
                                                        {opt.label}
                                                    </Radio>
                                                ...
                                                <Row gutter={[16, 16]} className="pl-4">
                                                    <Col span={12}>
                                                        ...
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="font-sans">
                                                                {formData?.businessSector === 'corporate1' ? 'ภาคการผลิต' : 'ภาคการค้า/การบริการ'}                              </p>
                                                        </div>
                                                    ...
                                                    <Col span={12}>
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="font-sans">
                                                                {selectedSizeLabel || 'ข้อมูลไม่ครบถ้วน'}
                                                            </p>
                                                        </div>
                                                    </Col>
                                                </Row>
                                                        ...
                                                        <ul className="space-y-3 text-sm font-sans pl-4">
                                                            <li className="flex gap-x-3">
                                                                ...
                                                                <span className="text-gray-800">
                                                                    {formData?.dataWithRisk === 'a1' ? 'ใช่' : formData?.dataWithRisk === 'a2' ? 'ไม่ใช่' : 'ไม่แน่ใจ'}
                                                                </span>
                                                            </li>
                                                        </ul>
                                                    </Col>
                                                    ...
                                                    <Col span={24}>
                                                        ...
                                                        <ul className="space-y-3 text-sm font-sans pl-4">
                                                            <li className="flex gap-x-3">
                                                                ...
                                                                <span className="text-gray-800">
                                                                    {formData?.occasionalProcessing === 'b1' ? 'ใช่' : formData?.occasionalProcessing === 'b2' ? 'ไม่ใช่' : 'ไม่แน่ใจ'}
                                                                </span>
                                                            </li>
                                                        </ul>
                                                    </Col>
                                                        ...
                                                        <div className="pl-4">
                                                            <ul className="space-y-3 text-sm font-sans ">
                                                                <li className="flex gap-x-3">
                                                                    ...
                                                                    <span className="text-gray-800">
                                                                        {formData?.section26Processing === 'c1' ? 'ใช่' : formData?.section26Processing === 'c2' ? 'ไม่ใช่' : 'ไม่แน่ใจ'}
                                                                    </span>
                                                                </li>
                                                            </ul>
                                                        </div>
